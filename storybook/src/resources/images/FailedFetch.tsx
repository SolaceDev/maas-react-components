...
const FailedFetch = (): JSX.Element => {
	const theme = useTheme();
	const border = theme.palette.ux.accent.n8.wMain;
	const fill = theme.palette.ux.background.w10;
	const haloFill = theme.palette.ux.error.w10;
	return (
		<SvgIcon sx={{ width: "131px", height: "131px" }} viewBox="0 0 131 131" fill="none">
			<path
				...
				fill={haloFill}
			/>
			<path d="M2.68115 119.495H128.681V120.495H2.68115V119.495Z" fill={border} />
			<rect
				x="14"
				y="34"
				width="104.054"
			...
			<path
				...
				strokeLinejoin="round"
			/>
			<path d="M15.1406 95.0068H117.773" stroke={border} strokeWidth="2" />
			<g clipPath="url(#clip0_1688:196070)">
				<rect opacity="0.2" x="54.1126" y="45.1681" width="24.1" height="24.1" stroke={border} strokeWidth="0.1" />
				<path
