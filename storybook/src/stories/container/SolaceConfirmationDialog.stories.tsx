...
export default {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"Dialogs inform users about a task and can contain critical information, require decisions, or involve multiple tasks. For more examples and documentation please refer to https://mui.com/components/dialogs/. Code component name: SolaceConfirmationDialog"
			}
		}
	},
	argTypes: {
