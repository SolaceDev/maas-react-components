...
<div style={{ display: "flex", alignItems: "center", margin: "8px 0" }}>
	...
	></div>
	<span>theme.palette.secondary.w20 - Hover background color for delete button</span>
</div>
...
- White background special case: Adds border using `theme.palette.secondary.w100`
