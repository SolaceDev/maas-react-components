 ...
 */
function processComponentUsage(stats, aggregatedStats, allComponents) {
...
export async function fetchApplicationStats(applicationName) {
    ...
    if (!validApplications.includes(applicationName)) {
        throw new Error(`Invalid application name: ${applicationName}. Valid applications are: ${validApplications.join(", ")}`);
    }
...
export async function getApplicationStats(applicationName) {
