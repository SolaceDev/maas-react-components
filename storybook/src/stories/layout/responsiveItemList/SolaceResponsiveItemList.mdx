...
**Theme Integration:**
The component uses Solace design tokens for:

- Default spacing calculations (`theme.spacing()`)
- Tooltip styling and behavior
- Button styling for "show more" controls
- Typography scaling for item content
- Color palette for interactive states
