 ...
 */
async function discoverMfes(forceRefresh = false) {
 ...
 */
/** @deprecated */
export async function getMfeInfo(mfeName, forceRefresh = false) {
 ...
 */
export async function listAllMfes(forceRefresh = false) {
    const mfeMapping = await discoverMfes(forceRefresh);
 ...
 */
export async function getApplicationForMfe(mfeName) {
    try {
