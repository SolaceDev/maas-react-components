...
export default {
	title: "Layout/SolaceNewSidePanel",
	component: SolaceNewSidePanel,
	parameters: {},
	argTypes: {}
} as ComponentMeta<typeof SolaceNewSidePanel>;
...
export const DefaultSidePanel = (): JSX.Element => {
	...
	return (
		<StoryContainer>
			<SolaceNewSidePanel showSidePanel={panelOpen} sidePanelContent={sidePanelMessage}>
				<SolaceDetailMessage
					msgImg={<NoAccessImg />}
...
export const CustomWidthSidePanel = (): JSX.Element => {
	...
	return (
		<StoryContainer>
			<SolaceNewSidePanel sidePanelContent={sidePanelMessage} showSidePanel={panelOpen} sidePanelWidth={500}>
				<div style={{ margin: "auto" }}>
					<SolaceDetailMessage
						msgImg={<NoAccessImg />}
...
export const SelfClosingSidePanel = (): JSX.Element => {
	...
	return (
		<StoryContainer>
			<SolaceNewSidePanel sidePanelContent={sidePanelContent} showSidePanel={panelOpen}>
				<div style={{ margin: "auto" }}>
					<SolaceDetailMessage
						msgImg={<NoAccessImg />}
