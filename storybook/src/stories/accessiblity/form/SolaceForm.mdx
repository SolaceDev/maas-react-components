...
<div style={{ display: "flex", alignItems: "center", margin: "8px 0" }}>
	...
	></div>
	<span>theme.palette.background.w10 - Main form background color and container backgrounds</span>
</div>
<div style={{ display: "flex", alignItems: "center", margin: "8px 0" }}>
	<div
		style={{
	...
	></div>
	<span>theme.palette.secondary.w20 - Border colors for tabs, sections, and dividers</span>
</div>
<div style={{ display: "flex", alignItems: "center", margin: "8px 0" }}>
	<div
		style={{
	...
	></div>
	<span>theme.palette.secondary.text.wMain - Secondary text color for labels and helper text</span>
</div>
