...
<div style={{ display: "flex", alignItems: "center", margin: "8px 0" }}>
	...
	></div>
	<span>theme.palette.primary.text.wMain - Stack item text color</span>
</div>
<div style={{ display: "flex", alignItems: "center", margin: "8px 0" }}>
	<div
		style={{
	...
	></div>
	<span>theme.palette.background.w10 - Stack container background</span>
</div>
<div style={{ display: "flex", alignItems: "center", margin: "8px 0" }}>
	<div
		style={{
	...
	></div>
	<span>theme.palette.background.w10 - Stack item background when container prop is true</span>
</div>
